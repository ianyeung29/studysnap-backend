...
async function testExtract() {
  console.log("Starting test for deployed /api/extract-image with a real image...");
  ...
  try {
    const res = await fetch('https://studysnap-backend-kittycatty.vercel.app/api/extract-image', {
      method: 'POST',
      body: formData
    });
